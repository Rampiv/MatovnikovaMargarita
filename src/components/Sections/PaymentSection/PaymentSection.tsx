        ...
        <div className="container">
          <div className="section__container">
            ...
            <div className="payment__content">
              ...
              <p className="payment__text payment__text_margin">
                Если вам важно со мной познакомиться и услышать вживую – мы
                можем устроить небольшой 10-15 минутный созвон, чтобы задать
                друг другу интересующие вопросы и договориться о формате работы.
              </p>
              <p className="payment__text"><u>Обратите внимание:</u> Стоимость консультаций может корректироваться с учётом повышения
                квалификации и изменений нагрузки</p>
            </div>
          </div>
        </div>
      </section>
